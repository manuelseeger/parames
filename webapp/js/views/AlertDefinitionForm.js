...
export const AlertDefinitionForm = {
  ...
  setup(props) {
    ...
    return {
      def, error, loading, saving, isEdit,
      modelsText, deliveryText,
      hasTimeWindow, hasDry, hasModelAgreement,
      toggleTimeWindow, toggleDry, toggleModelAgreement,
      addBisePlugin, removePlugin,
      submit, cancel,
    };
  },
  template: `
